...
SOURCES = \
	__init__.py \
	entf_besch.py entf_besch_dialog.py

PLUGINNAME = entf_besch

PY_FILES = \
	__init__.py \
	entf_besch.py entf_besch_dialog.py

UI_FILES = entf_besch_dialog_base.ui
...
QGISDIR=C:\Users\Schäfer\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
